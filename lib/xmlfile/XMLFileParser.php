...
include_once get_lib("phpscript.PHPScriptHandler");
include_once get_lib("util.MyArray");
include_once get_lib("util.xml.MyXML");
include_once get_lib("util.xml.MyXMLArray");
include_once get_lib("util.xml.MyXSD");
include_once get_lib("xmlfile.exception.XMLFileParserException");
