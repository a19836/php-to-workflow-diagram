...
include_once get_lib("workflow.IWorkFlowTask");
include_once get_lib("workflow.exception.WorkFlowTaskException");
...
abstract class WorkFlowTask implements IWorkFlowTask {
	...
	public static function getVariableValueCode($variable, $type = null) {
		...
		if ($type == "variable" && $v)
			...
			/*
			 * 2021-10-30: All comments below were copied from phpscript/PHPUICodeExpressionHandler::getArgumentCode.
			 *
			 * 2019-11-28: 
