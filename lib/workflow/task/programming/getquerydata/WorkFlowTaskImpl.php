...
include_once get_lib("workflow.WorkFlowTask");
...
class WorkFlowTaskImpl extends \WorkFlowTask {
	...
	public function printCode($tasks, $stop_task_id, $prefix_tab = "", $options = null) {
		...
		if (!empty($properties["sql"])) {
			...
			$code .= self::getVariableValueCode(isset($properties["sql"]) ? $properties["sql"] : null, isset($properties["sql_type"]) ? $properties["sql_type"] : null);
